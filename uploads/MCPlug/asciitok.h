...
#define ID_MAP_NORMAL_T("*MAP_NORMAL")
#define ID_MAP_ROUGHNESS_T("*MAP_ROUGHNESS")
#define ID_MAP_METALLIC_T("*MAP_METALLIC")
#define ID_MAP_EMISSIVE_T("*MAP_EMISSIVE")
#define ID_MAP_AO_T("*MAP_AO")
#define ID_MAP_HEIGHT_T("*MAP_HEIGHT")

#define ID_MAP_NORMAL		"*MAP_NORMAL"
#define ID_MAP_ROUGHNESS	"*MAP_ROUGHNESS"
#define ID_MAP_METALLIC		"*MAP_METALLIC"
#define ID_MAP_EMISSIVE		"*MAP_EMISSIVE"
#define ID_MAP_AO			"*MAP_AO"
#define ID_MAP_HEIGHT		"*MAP_HEIGHT"

// ===== PBR Map IDs for 3ds Max =====
#define ID_NORMAL_MAP		8   // Normal map slot
#define ID_ROUGHNESS_MAP	9   // Roughness map slot
#define ID_METALLIC_MAP		10  // Metallic map slot
#define ID_EMISSIVE_MAP		11  // Emissive map slot
#define ID_AO_MAP			12  // Ambient Occlusion map slot
#define ID_HEIGHT_MAP		13  // Height/Displacement map slot
